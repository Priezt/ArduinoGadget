...
{
	main_W_com_data(0x50,x0);  // Horizontal GRAM Start Address
	main_W_com_data(0x51,x1);  // Horizontal GRAM End Address
	main_W_com_data(0x52,y0);  // Vertical GRAM Start Address
